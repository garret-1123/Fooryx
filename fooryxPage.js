...
likeTag ="<button class='btn btn-success' id="+firebaseMessageId+" value="+like+" onclick='updateLike(this.id)'>";
...
function updateLike(mID) {
      ...
      like2 = document.getElementById(mID).value;
      updatedLike = Number(like2) + 1;
      firebase.database().ref(room).child(mID).update({
      like : updatedLike
